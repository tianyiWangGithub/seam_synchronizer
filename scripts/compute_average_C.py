...
results_path = os.path.join(current_directory, "..", "results/validation_seam_computetime/C")
...
# Write the averages to data_ct_C.txt
output_path = os.path.join(results_path, "data_ct_C.txt")
