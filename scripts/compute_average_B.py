...
results_path = os.path.join(current_directory, "..", "results/validation_seam_computetime/B")
...
# Write the averages to data_ct_B.txt
output_path = os.path.join(results_path, "data_ct_B.txt")
