...
# 读取数据
data = np.loadtxt('/home/wty/ros2_dashing/src/seam_synchronizer/results/validation_seam_success_rate/channel_num/success_rate.txt')
data_ct = np.loadtxt("/home/wty/ros2_dashing/src/seam_synchronizer/results/validation_seam_computetime/channel/data_ct_N.txt")
...
ax.set_xticklabels(['3','4','5', '6', '7','8','9'],size='30')
...
plt.savefig('seam_apr_N', dpi=400)
