...
# 读取数据
data = np.loadtxt('/home/wty/ros2_dashing/src/seam_synchronizer/results/validation_seam_success_rate/period/success_rate.txt')
data_ct = np.loadtxt("/home/wty/ros2_dashing/src/seam_synchronizer/results/validation_seam_computetime/period/data_ct_P.txt")
...
ax.set_xticklabels(['[10-100]', '[20-100]', '[30-100]', '[40-100]', '[50-100]'],size='30')
ax.set_xlabel('P(ms)',size='30')
...
# 显示图形
plt.savefig('seam_apr_period', dpi=400)
plt.show()