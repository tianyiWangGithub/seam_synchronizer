...
# 读取数据
data = np.loadtxt('/home/wty/ros2_dashing/src/seam_synchronizer/results/validation_seam_success_rate/C/success_rate.txt')
data_ct = np.loadtxt("/home/wty/ros2_dashing/src/seam_synchronizer/results/validation_seam_computetime/C/data_ct_C.txt")
...
ax.set_xticklabels(['75','80','85', '90', '95','100','105','110','115','120'],size='30')
ax.set_xlabel('C(ms)',size='30')
...
plt.savefig('seam_apr_C', dpi=400)
plt.show()