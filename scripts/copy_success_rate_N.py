...
results_path = os.path.join(current_directory, "..", "results/validation_seam_success_rate/channel_num")

# Define the subfolder names
subfolder_names = ["channle_3", "channle_4", "channle_5", "channle_6", "channle_7", "channle_8", "channle_9"]
