...
results_path = os.path.join(current_directory, "..", "results/validation_seam_computetime/Tw_Tb")
...
# Write the averages to data_ct_ratio.txt
output_path = os.path.join(results_path, "data_ct_ratio.txt")
