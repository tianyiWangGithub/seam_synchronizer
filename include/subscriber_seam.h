    ...
    : public rclcpp::Node
{
    ...
    public:
    SubscriberTopic2(int period1, int period2, int x_ms, int length_ms, int BOUND_Between_ms, std::ofstream& outfile_apr, std::ofstream& outfile_seam) :
        Node("subscriber_topic2"),  outfile_apr_(outfile_apr), outfile_seam_(outfile_seam), 
    ...
    : public rclcpp::Node
{
    ...
    public:
    SubscriberTopic3(int period1, int period2, int period3, int x_ms, int length_ms, int BOUND_Between_ms, std::ofstream& outfile_apr, std::ofstream& outfile_seam) :
        Node("subscriber_topic3"), outfile_apr_(outfile_apr), outfile_seam_(outfile_seam),
    ...
    : public rclcpp::Node
{
    ...
    public:
    SubscriberTopic4(int period1, int period2, int period3, int period4, int x_ms, int length_ms, int BOUND_Between_ms, std::ofstream& outfile_apr, std::ofstream& outfile_seam) :
        Node("subscriber_topic4"), outfile_apr_(outfile_apr), outfile_seam_(outfile_seam),
    ...
    : public rclcpp::Node
{
    ...
    public:
    SubscriberTopic5(int period1, int period2, int period3, int period4, int period5, int x_ms, int length_ms, int BOUND_Between_ms, std::ofstream& outfile_apr, std::ofstream& outfile_seam) :
        Node("subscriber_topic5"), outfile_apr_(outfile_apr), outfile_seam_(outfile_seam),
        apr_sync_(buffer_size), seam_sync_(), 
    ...
    : public rclcpp::Node
{
    ...
    public:
    SubscriberTopic6(int period1, int period2, int period3, int period4, int period5, int period6, int x_ms, int length_ms, int BOUND_Between_ms, std::ofstream& outfile_apr, std::ofstream& outfile_seam) :
        Node("subscriber_topic6"), outfile_apr_(outfile_apr), outfile_seam_(outfile_seam), 
        apr_sync_(buffer_size), seam_sync_(), 
    ...
    : public rclcpp::Node
{
    ...
    public:
    SubscriberTopic7(int period1, int period2, int period3, int period4, int period5, int period6, int period7, int x_ms, int length_ms, int BOUND_Between_ms, std::ofstream& outfile_apr, std::ofstream& outfile_seam) :
        Node("subscriber_topic7"), outfile_apr_(outfile_apr), outfile_seam_(outfile_seam),
        apr_sync_(buffer_size), seam_sync_(), 
    ...
    : public rclcpp::Node
{
    ...
    public:
    SubscriberTopic8(int period1, int period2, int period3, int period4, int period5, int period6, int period7, int period8, int x_ms, int length_ms, int BOUND_Between_ms, std::ofstream& outfile_apr, std::ofstream& outfile_seam) :
        Node("subscriber_topic8"), outfile_apr_(outfile_apr), outfile_seam_(outfile_seam),
        apr_sync_(buffer_size), seam_sync_(), 
    ...
    : public rclcpp::Node
{
    ...
    public:
    SubscriberTopic9(int period1, int period2, int period3, int period4, int period5, int period6, int period7, int period8, int period9, int x_ms, int length_ms, int BOUND_Between_ms, std::ofstream& outfile_apr, std::ofstream& outfile_seam) :
        Node("subscriber_topic9"), outfile_apr_(outfile_apr), outfile_seam_(outfile_seam),
        apr_sync_(buffer_size), seam_sync_(), 
