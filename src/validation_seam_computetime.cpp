...
#include "publisher.h"
#include "subscriber_compute_time.h"
...
int main(int argc, char * argv[])
{
    ...
    ofstream outfile_ct_apr_;
    ofstream outfile_ct_seam_;
    ...
    // Compute time of ApproximateTime and SEAM
    outfile_ct_apr_.open(result_path + "/compute_time_apr.txt", ios::out);
    if (!outfile_ct_apr_.is_open()) 
    {
        cout<<"Error opening file compute_time_apr.txt! "<<endl;
    }

    outfile_ct_apr_.setf(ios::fixed, ios::floatfield);
    outfile_ct_apr_.precision(9);

    outfile_ct_seam_.open(result_path + "/compute_time_seam.txt", ios::out);
    if (!outfile_ct_seam_.is_open()) 
    {
        cout<<"Error opening file compute_time_seam.txt! "<<endl;
    }

    outfile_ct_seam_.setf(ios::fixed, ios::floatfield);
    outfile_ct_seam_.precision(9);
    ...
    case 2:
    {
        ...
        while(count < test_num)
        {
            ...
            auto sub_node = std::make_shared<SubscriberTopic2>(real_period1, real_period2, BOUND_ms, length_ms, BOUND_Between_ms, outfile_apr_, outfile_seam_, outfile_ct_apr_, outfile_ct_seam_);
    ...
    {   
        ...
        while(count < test_num)
        {
            ...
            auto sub_node = std::make_shared<SubscriberTopic3>(real_period1, real_period2, real_period3, BOUND_ms, length_ms, BOUND_Between_ms, outfile_apr_, outfile_seam_, outfile_ct_apr_, outfile_ct_seam_);
            executor.add_node(sub_node);
    ...
    case 4:
    {
        ...
        while(count < test_num)
        {
            ...
            auto sub_node = std::make_shared<SubscriberTopic4>(real_period1, real_period2, real_period3, real_period4, BOUND_ms, length_ms, BOUND_Between_ms, outfile_apr_, outfile_seam_, outfile_ct_apr_, outfile_ct_seam_);
            executor.add_node(sub_node);
    ...
    case 5:
    {
        ...
        while(count < test_num)
        {
            ...
            auto sub_node = std::make_shared<SubscriberTopic5>(real_period1, real_period2, real_period3, real_period4, real_period5, BOUND_ms, length_ms, BOUND_Between_ms, outfile_apr_, outfile_seam_, outfile_ct_apr_, outfile_ct_seam_);
            executor.add_node(sub_node);
    ...
    case 6:
    {
        ...
        while(count < test_num)
        {
            ...
            auto sub_node = std::make_shared<SubscriberTopic6>(real_period1, real_period2, real_period3, real_period4, real_period5, real_period6, BOUND_ms, length_ms, BOUND_Between_ms, outfile_apr_, outfile_seam_, outfile_ct_apr_, outfile_ct_seam_);
            executor.add_node(sub_node);
    ...
    case 7:
    {
        ...
        while(count < test_num)
        {
            ...
            auto sub_node = std::make_shared<SubscriberTopic7>(real_period1, real_period2, real_period3, real_period4, real_period5, real_period6, real_period7, BOUND_ms, length_ms, BOUND_Between_ms, outfile_apr_, outfile_seam_, outfile_ct_apr_, outfile_ct_seam_);
            executor.add_node(sub_node);
    ...
    case 8:
    {
        ...
        while(count < test_num)
        {
            ...
            auto sub_node = std::make_shared<SubscriberTopic8>(real_period1, real_period2, real_period3, real_period4, real_period5, real_period6, real_period7, real_period8, BOUND_ms, length_ms, BOUND_Between_ms, outfile_apr_, outfile_seam_, outfile_ct_apr_, outfile_ct_seam_);
            executor.add_node(sub_node);
    ...
    case 9:
    {
        ...
        {        
            ...
            auto sub_node = std::make_shared<SubscriberTopic9>(real_period1, real_period2, real_period3, real_period4, real_period5, real_period6, real_period7, real_period8, real_period9, BOUND_ms, length_ms, BOUND_Between_ms, outfile_apr_, outfile_seam_, outfile_ct_apr_, outfile_ct_seam_);
            executor.add_node(sub_node);
